            ...
            <div class="col-xs-12 col-sm-6 ml-auto text-right mb-2">
                <div class="dropdown d-inline">
                    ...
                    <div class="dropdown-menu" aria-labelledby="droprop-action">
                        <a href="<?= base_url('gaji/export/?bulan='.$bulan."&tahun=$tahun") ?>" class="dropdown-item" target="_blank"><i class="fa fa-file-pdf-o"></i> Rekap Gaji</a>
                        <a href="<?= base_url('assets/pdf/dpa.pdf') ?>" class="dropdown-item" target="_blank"><i class="fa fa-file-pdf-o"></i> DPA</a>
