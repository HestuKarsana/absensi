        ...
        <div class="card">
            <form action="<?= base_url('karyawan/update') ?>" method="post">
                <div class="card-header">
                    <h4 class="card-title">Rubah Data Karyawan</h4>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" id="nama" value="<?= $karyawan->nama ?>" class="form-control" placeholder="Masukana Nama Lengkap Karyawan" required="required" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="divisi" id="divisi" value="<?= $karyawan->divisi ?>" class="form-control" placeholder="Masukan Jabatan" required="required" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="card-body border-top py-0 my-3">
                    <h4 class="text-muted my-3">Pengaturan Akun</h4>
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                <label for="username">Username</label>
                                <input type="text" name="username" id="username" value="<?= $karyawan->username ?>" class="form-control" placeholder="Masukan Username" required="required" disabled/>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-primary">Ubah <i class="fa fa-save"></i></button>
                </div>
            </form>
        </div>
    </div>
